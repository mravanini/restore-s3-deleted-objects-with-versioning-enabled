...
#TODO: colocar o nome do bucket
bucket_name = 'nome-do-bucket'


#TODO: colocar a data a partir de quando vamos restaurar objetos deletados
# datetime(year, month, day, hour, minute, second, microsecond, UTC-00:00)
point_of_restore = datetime.datetime(2021, 12, 10, 16, 0, 0, 0, pytz.UTC)
    ...
    if 'DeleteMarkers' in response:
        ...
        if latest_version['IsLatest']:
            ...
            if point_of_restore < last_modified:
                logger.warning("Object was deleted after point of restore. Activation will continue for object %s ",
                           object_key)
